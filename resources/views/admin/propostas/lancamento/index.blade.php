      ...
      <tbody>
        @foreach($propostas as $proposta)
          <tr>
            ...
            <td><a href="{{ route('data_editable', ['id' => $proposta->id, 'entidade' => 'proposta', 'return' => '/proposta/lancamento']) }}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a></td>
          </tr>
        @endforeach
      </tbody>
      <tfoot>
