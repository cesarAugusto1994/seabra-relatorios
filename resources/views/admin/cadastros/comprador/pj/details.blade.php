...
@section('title', 'Seabra - Cadastro Comprador Pessoa Juridica')

@section('content_header')
    <h1>Cadastro Comprador Pessoa Juridica N. {{ $pessoa->id }}</h1>
@stop
...
<div class="box box-default">
  <div class="box-header with-border">
    ...
    <div class="box-tools pull-right">
      <a class="btn btn-google btn-xs" href="{{ url('/cadastro/pessoa-juridica') }}">Voltar</a>
    </div>
  </div>
  <div class="box-body">
      <div class="row">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-striped no-margin">
                      ...
                      <tr>
                        ...
                        <td>{{ $pessoa->responsavel->endereco->logradouro }}</td>
                      </tr>
