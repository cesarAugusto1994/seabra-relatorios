      ...
      <tbody>
        @foreach($pessoas as $pessoa)
          <tr>
            ...
            <td><a href="{{ route('data_editable', ['id' => $pessoa->id, 'entidade' => 'pessoa', 'return' => '/cadastro/pessoa-juridica']) }}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a></td>
          </tr>
        @endforeach
      </tbody>
      <tfoot>
