      ...
      <tbody>
        @foreach($pessoas as $pessoa)
          <tr>
            ...
            <td><a data-destino="{{ url('/cadastro/pessoa-fisica/') }}" data-table="pessoas" href="{{ route('data_destroy', ['id' => $pessoa->id]) }}" class="btn btn-danger btn-xs btnRemoverRegistro2"><i class="fa fa-trash"></i> Remover</a></td>
            <td><a href="{{ route('data_editable', ['id' => $pessoa->id, 'entidade' => 'pessoa', 'return' => '/cadastro/pessoa-fisica']) }}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editar</a></td>
          </tr>
        @endforeach
      </tbody>
      <tfoot>
